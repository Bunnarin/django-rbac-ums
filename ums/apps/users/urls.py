...
urlpatterns = [
    ...
    path('export/', views.UserExportView.as_view(), name='export_customuser'),
    # student
    ...
    path('students/export/', views.StudentExportView.as_view(), name='export_student'),
    # professor
    ...
    path('professors/export/', views.ProfessorExportView.as_view(), name='export_professor'),
]
