...
class Schedule(OrganizationMixin):
    ...
    monday = models.TextField(max_length=255, null=True, blank=True)
    tuesday = models.TextField(max_length=255, null=True, blank=True)
    wednesday = models.TextField(max_length=255, null=True, blank=True)
    thursday = models.TextField(max_length=255, null=True, blank=True)
    friday = models.TextField(max_length=255, null=True, blank=True)
    saturday = models.TextField(max_length=255, null=True, blank=True)
    sunday = models.TextField(max_length=255, null=True, blank=True)
